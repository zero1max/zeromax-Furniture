...
class WeHelp(models.Model):
    title = models.CharField(max_length=155, verbose_name='Sarlavha')
    description = models.TextField()
    photo1 = models.ImageField(upload_to='images/%Y/%m/%d', blank=True)
    photo2 = models.ImageField(upload_to='images/%Y/%m/%d', blank=True)
    photo3 = models.ImageField(upload_to='images/%Y/%m/%d', blank=True)
...
class OrderProduct(models.Model):
    product = models.ForeignKey(Furniture, on_delete=models.SET_NULL, blank=True, null=True)
